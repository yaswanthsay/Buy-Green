...
function Navbar() {
    ...
    return (
        <>
            ...
            {menu ? <Menu /> : <div className='nav__container'>
                <div className='navbar'>
                    <div className='nav__left'>
                        {menu ? <img src='/close.png' alt='' className='menu__close' /> :
                            <img src='/sidemenu.png' alt='' className='nav__menu' onClick={() => setMenu(true)} />}
